...
func (h *Handlers) CompletedFilterParams() func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if strings.Contains(contentType, "multipart/form-data") {
			...
			if IdsStr == "" {
				a := h.GetCompletedTendersListwindow(nil)
				a(w, r)
				return
			}
			...
			a := h.GetCompletedTendersListwindow(Ids)
			a(w, r)
			return
		}
...
func (h *Handlers) GetCompletedTendersListwindow(FilterParams []int) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		tmpl, err := template.ParseFiles("./client/pages/completed_tender_list.html")
		if err != nil {
