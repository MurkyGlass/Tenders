...
async function EditTenderForm(id) {
    const formData = new FormData(document.getElementById('tenderForm'));
  
        const response = await fetch('/protected/lk/tenders/'+id+'/edit', {//
            method: 'POST',
            body: formData
        });
        if (response.ok){
...
async function EditDraftTenderForm(id) {
    const formData = new FormData(document.getElementById('tenderForm'));
  
        const response = await fetch('/protected/lk/tenders/'+id+'/edit/draft', {//
            method: 'POST',
            body: formData
        });
        if (response.ok){
